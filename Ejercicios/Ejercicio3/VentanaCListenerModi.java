...
public class VentanaCListenerModi extends Frame implements ActionListener {
    ...
    public static void main(String args[]) {
        VentanaCListenerModi v = new VentanaCListenerModi();
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (arg0.getSource() == btn_click) {
            ...
            if(texto=="SUMAR"){
                txt_result.append(texto +resultado);
            }
        }
